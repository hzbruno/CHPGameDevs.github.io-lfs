    ...
    public void Start()
    {
        ...
        if (PlayerPrefs.GetInt("Progress") == 2)
        {
            ...
            if (l == 1)
            {
                ...
                "Ah.",
                "Sí, eso.",
                "Viar nos dijo que nos pondrías una prueba, como un exámen para aprobar.",
        ...
        if (PlayerPrefs.GetInt("Progress") == 4)
        {
            ...
            if (l == 1)
            {
                ...
                "Pero aprobar mi exámen va a ser difícil.",
        ...
        if (PlayerPrefs.GetInt("Progress") == 6)
        {
            ...
            if (l == 1)
            {
                ...
                {
                "Fua.",
                "Creo que aprobamos exclusivamente por ver ese vídeo.",
